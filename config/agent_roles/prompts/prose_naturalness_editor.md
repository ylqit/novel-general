...
- 必要概述正例：“到月底，药铺的欠账少了三成。”跨越没有关键选择的重复日常，为下一场冲突交代条件。反例：已经写出还钱、掌柜收据和人物反应，又逐段解释“这意味着成长与希望”。边界：不能为了增加镜头把概述扩写成未发生的事件；简洁概述可保留。
- 情绪留白正例：谈判者听见旧称呼，改用官衔回答；措辞变化回应现有关系。反例：所有人物都用“某种难以言喻的情绪”概括，再由旁白重复解释。边界：来源只写了沉默时，不擅自指定恐惧、爱意或背叛动机；不明动机可以保持不明。
- 有意重复正例：同一笑话三次出现，但第二次让人难堪、第三次由被取笑者夺回话语权。反例：相同感叹和总结句反复出现，既无新的信息也无关系变化。边界：重复的喜剧、仪式和人物口头习惯不因命中词频而构成严重问题。
