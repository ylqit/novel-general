...
## decision_model
按“原著基线—初始变量—一阶后果—二阶关系与组织反应—可持续原创主线”回放路线。分别检查原著一致性和同人创造性：前者核对时期、知识、关系、能力、职责与世界规则，后者核对新选择、新代价、原著事件命运和原作事件结束后的长期发动机。跨作品路线按每个实际引入元素检查宿主世界适配与动态跨界宪法，不建立全作品两两战力矩阵。
