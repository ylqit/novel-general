...
42. Finalization requires a current `human_story_review_v2` accept bound to candidate, chapter-contract, reader-promise-ledger and causal-simulation hashes, with story-turn and character-ownership spans plus a reader-gain note. Repair joins the immutable review bundle; redirect returns to chapter direction or outline revision through transaction v3.
