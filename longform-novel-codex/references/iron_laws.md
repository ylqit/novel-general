...
33. Each newly finalized chapter must use one `chapter_semantic_bundle_v1`. The default production path must not create separate graph, chapter-memory, and character-memory Agent extraction tasks for the same final.
