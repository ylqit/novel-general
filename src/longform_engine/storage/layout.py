...
SUBDIRECTORIES = [
    ...
    "50_workbench/planning",
    "50_workbench/event_realizations",
    "50_workbench/promise_evidence",
    "50_workbench/reader_feedback",
    "50_workbench/revision_branches",
...
INITIAL_JSON_FILES = {
    ...
    "30_state/reader_promise_ledger.json": {
        "schema": "reader_promise_ledger_v2",
        "items": [],
    },
    "10_bible/canonical_facts.json": {
        "schema": "canonical_fact_registry_v2",
        "items": [],
    },
    "30_state/stale_artifacts.json": {
        "schema": "stale_artifact_registry_v1",
        "items": [],
    },
