...
TASK_OBJECTIVES: dict[str, str] = {
    ...
    "chapter_coedit_rewrite": "只把人类选中的协作方案实现为完整非 canonical 候选，并保持意图与保护项。",
    "character_expression_design": "定义可观察的人物选择、声音、身体反应、社会面具和关系压力合同。",
    "character_expression_review": "依据证据判断人物声音、具身表现、对白功能和关系压力。",
    "character_interpretation": "按时期、知识边界、价值排序、关系阶段和压力条件形成开放人物理解。",
    ...
    "source_candidate_triage": "按当前资料缺口筛选来源候选，记录相关性、版本和停止理由。",
    "source_conflict_analysis": "比较不同媒介、译本或版本的证据，区分冲突、补充与表现差异。",
    "source_coverage_gap_analysis": "只依据声明的覆盖单元和已核验证据报告资料缺口，不扩大抓取范围。",
    "source_discovery_planning": "根据当前创作需求规划搜索范围、来源类别和停止条件。",
    "source_evidence_review": "独立复核规范化片段、原始定位和 OCR/ASR/视觉证据边界。",
    "source_fact_extraction": "从已核验规范化片段提取带稳定 ID 和精确证据的非 Canon 事实候选。",
    "source_timeline_alignment": "联合字幕、语音、镜头和动作证据，提出可回溯的时间线对齐候选。",
    "source_version_conflict_review": "并列比较版本证据和冲突，不替人工选择或混合版本。",
