...
def test_cli_mutating_commands_are_marked_for_project_lock():
    ...
    read_only_cases = [
        ...
        ("agent-task", "show", "project.yaml", "chapter_write:ch001:v5"),
        ("agent-task", "brief", "project.yaml", "chapter_write:ch001:v5"),
        ("agent-task", "validate", "project.yaml", "chapter_write:ch001:v5", "--strict"),
