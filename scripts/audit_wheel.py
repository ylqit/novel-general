...
REQUIRED = (
    ...
    "longform_engine/arc_simulation.py",
    "longform_engine/benchmark.py",
    "longform_engine/blind_review.py",
    "longform_engine/chapter_contract.py",
    "longform_engine/chapter_coedit.py",
    "longform_engine/story_brief.py",
    "longform_engine/distribution.py",
    "longform_engine/author_voice.py",
    "longform_engine/human_author_revision.py",
    "longform_engine/human_chapter_intent.py",
    "longform_engine/human_story_review.py",
    "longform_engine/human_review_consultation.py",
    "longform_engine/intelligence/pipeline.py",
    "longform_engine/quality/contracts.py",
    "longform_engine/quality/editorial_patterns.py",
    ...
    "longform_engine/vector_backends.py",
    ...
    "longform_engine/resources/config/agent_roles/prompts/prose_revision_semantic_reviewer.md",
    "longform_engine/resources/config/agent_roles/playbooks/opening_and_mainline.md",
    "longform_engine/resources/config/platform_publication_policy_registry.json",
    "longform_engine/resources/config/quality_profiles/market_evidence_registry.yaml",
    "longform_engine/resources/config/quality_profiles/markets/fanqie_free.yaml",
    ...
    "longform_engine/resources/config/agent_protocol_acceptance_fixtures.yaml",
